export const SentenceTrainEngine = {
    ...
    renderLabeling: async (container, data) => {
        ...
        s.pollyIcon = window.ManyaQuestRunner?.CHAR_ICONS?.polly || s.pollyIcon;
    ...
    endGame: () => {
        ...
        s.container.innerHTML = `
            <div class="bento-card" style="text-align:center; padding:40px; animation: popIn 0.5s;">
                ...
                <button class="manya-pill-btn" onclick="window.ManyaQuestRunner.next()" style="margin-top:20px;">FINISH QUEST</button>
            </div>
        `;
