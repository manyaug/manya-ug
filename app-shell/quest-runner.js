        ...
        s.mount.innerHTML = `
            <div class="quest-runner-shell animate-in">
                <header class="qr-classic-header">
                    ...
                    <div class="qr-title-box"><span class="qr-subject-tag">${headerTitle}</span></div>
                    
                    <!-- DEV SKIP BUTTON -->
                    <button class="qr-skip-btn" onclick="QuestRunner.next(true)">SKIP</button> 

                    <div class="qr-progress-bar"><div class="fill" style="width: ${progress}%"></div></div>
                </header>
