            ...
            <AnimatePresence>
                {showGemToast && (
                    <motion.div 
                        ...
                        className="absolute top-20 right-4 bg-indigo-500 text-white px-3 py-1.5 rounded-full text-xs font-black z-20 flex items-center gap-1 pointer-events-none shadow-lg"
                    >
