...
export default function MathFetcherEngine({ data, onComplete, onResult }) {
    ...
    if (isLoading) return (
        <div className="flex-1 flex flex-col items-center justify-center p-8 bg-emerald-50/30 overflow-hidden relative">
            {/* Background Decorations */}
            <div className="absolute top-20 -left-10 w-40 h-40 bg-emerald-200/20 rounded-full blur-3xl animate-pulse" />
            <div className="absolute bottom-20 -right-10 w-60 h-60 bg-green-200/20 rounded-full blur-3xl animate-pulse delay-700" />
            
            <div className="relative z-10 flex flex-col items-center">
                {/* Bouncing Subject Coin */}
                <div className="relative mb-12">
                    {/* Orbiting Ring */}
                    <div className="absolute inset-[-15px] border-4 border-dashed border-emerald-200 rounded-full animate-[spin_8s_linear_infinite]" />
                    
                    <div className="w-24 h-24 bg-emerald-500 rounded-full shadow-2xl flex items-center justify-center text-white animate-[bounce_2s_infinite] border-4 border-white">
                ...
                <div className="space-y-6 text-center max-w-xs">
                    <div className="space-y-2">
                        ...
                        <div className="flex justify-center gap-1">
                            ...
                            <div className="w-3 h-3 bg-emerald-400 rounded-full animate-bounce" style={{ animationDelay: '200ms' }} />
                            <div className="w-3 h-3 bg-emerald-400 rounded-full animate-bounce" style={{ animationDelay: '400ms' }} />
                        </div>
                    </div>

                    {/* Fun Loading Fact */}
                    <div className="bg-white/60 backdrop-blur-md rounded-3xl p-5 border-2 border-emerald-100 shadow-sm">
                        <p className="text-[10px] font-black text-emerald-600 uppercase tracking-widest mb-2 opacity-60">Math Secret!</p>
                        <p className="text-xs font-bold text-emerald-950 leading-relaxed italic m-0">
                            "The symbol for division (÷) is called an 'obelus'."
                        </p>
                    </div>

                    <p className="text-[9px] font-black text-slate-400 uppercase tracking-[0.2em]">
                        Preparing Number Land...
                    </p>
                </div>
            </div>
        </div>
