...
export default function SSTFetcherEngine({ data, onComplete, onResult }) {
    ...
    useEffect(() => {
        const loadQuestions = async () => {
            ...
            try {
                ...
                console.log(`\ud83c\udfaf [SST Adaptive v4.5] ${nodeType} quest generated:`, {
                    ...
                    isFuzzyMatch: allQuestions.length > 0 && !allQuestions.some(q => q.subtopic === topicId),
    ...
    if (isLoading) {
        const cfg = getLoadingConfig('sst');
        const randomFact = getRandomFact('sst');
            ...
            <div className="quest-loading-overlay" style={{ '--loader-color': cfg.color, '--loader-dark': cfg.colorDark, '--loader-bg': cfg.bgLight }}>
                ...
                <div className="loader-content-card">
                    ...
                    <div className="loader-mascot-ring" style={{ borderColor: cfg.color }}>
                        <img src={cfg.mascot} alt="Zany" className="loader-mascot-img" />
                    </div>
            ...
            <div className="flex-1 flex flex-col animate-in fade-in duration-500 overflow-hidden relative" style={{ maxHeight: '100%' }}>
                ...
                <div className="flex-1 flex flex-col px-4 pt-4 overflow-hidden">
                    ...
                    <div 
                        ...
                        style={{ '--sub-theme-bg': '#f59e0b', '--sub-theme-border': '#b45309' }}
                    >
                            ...
                            {!isAnswered && q.hint && (
                                <div className="relative">
                                    <button 
                                        ...
                                        className={`p-2 rounded-xl transition-all relative z-10 ${hintUsed ? 'bg-[var(--sub-theme-bg)] text-white shadow-lg shadow-amber-500/30' : 'bg-slate-100 dark:bg-slate-800 text-slate-400'}`}
                                    >
                                        <Lightbulb size={18} />
                                    </button>
