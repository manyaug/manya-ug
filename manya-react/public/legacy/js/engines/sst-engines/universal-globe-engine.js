...
/* ... rest of existing styles ... */
    ...
    draw: () => {
        ...
        const curCase = (data.mode === 'study') ? data.cases[activeTab] : 
                        (data.mode === 'quiz') ? data.questions[activeTab] : null;
        ...
        if (data.mode === 'study') {
            ...
            sheet.innerHTML = `
                ...
                <div class="globe-body">
                    ...
                    ${cur.hint ? `<div class="g-hint-box" style="background:#FFFDF0; border:1.5px dashed #F59E0B; padding:12px; border-radius:14px; margin-bottom:15px; font-size:12px; font-weight:700; color:#B45309;"><span style="margin-right:6px">💡</span>HINT: ${cur.hint}</div>` : ''}
            ...
            sheet.innerHTML = `
                <div class="globe-body">
                    ...
                    ${q.hint ? `<div class="g-hint-box" style="background:#FFFDF0; border:1.5px dashed #F59E0B; padding:12px; border-radius:14px; margin-bottom:15px; font-size:12px; font-weight:700; color:#B45309;"><span style="margin-right:6px">💡</span>HINT: ${q.hint}</div>` : ''}
    ...
    handleQuizAnswer: (btn, word) => {
        ...
        if (word === q.correctAnswer) {
            ...
            if(window.addToast) window.addToast({message: "Correct!", type: "success"});
            setTimeout(() => {
            ...
            if(window.addToast) window.addToast({message: "Try again Hero!", type: "error"});
