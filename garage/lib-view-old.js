            ...
            topics: [
                {
                    ...
                    practice: Array.from({length: 10}, (_, i) => ({ label: `Q ${i+1}`, action: `ManyaRouter.load('math/set_theory', 'quest_01_finite_infinite_sets', '01-0${i+1 < 10 ? '0'+(i+1) : i+1}', this)` }))
                },
                {
                    ...
                    practice: Array.from({length: 20}, (_, i) => ({ label: `Q ${i+1}`, action: `ManyaRouter.load('math/set_theory', 'quest_02_set_notation_regions', '02-0${i+1 < 10 ? '0'+(i+1) : i+1}', this)` }))
                },
                {
                    ...
                    practice: Array.from({length: 10}, (_, i) => ({ label: `Q ${i+1}`, action: `ManyaRouter.load('math/set_theory', 'quest_03_calculating_subsets', '03-0${i+1 < 10 ? '0'+(i+1) : i+1}', this)` }))
                },
                {
                    ...
                    practice: Array.from({length: 10}, (_, i) => ({ label: `Q ${i+1}`, action: `ManyaRouter.load('math/set_theory', 'quest_04_calculating_proper_subsets', '04-0${i+1 < 10 ? '0'+(i+1) : i+1}', this)` }))
                },
                {
                    ...
                    practice: Array.from({length: 20}, (_, i) => ({ label: `Q ${i+1}`, action: `ManyaRouter.load('math/set_theory', 'quest_05_working_backwards', '05-0${i+1 < 10 ? '0'+(i+1) : i+1}', this)` }))
                },
                {
                    ...
                    practice: Array.from({length: 30}, (_, i) => ({ label: `Q ${i+1}`, action: `ManyaRouter.load('math/set_theory', 'quest_06_placing_info_on_venn_diagrams', '06-0${i+1 < 10 ? '0'+(i+1) : i+1}', this)` }))
                },
                {
                    ...
                    practice: Array.from({length: 29}, (_, i) => ({ label: `Q ${i+1}`, action: `ManyaRouter.load('math/set_theory', 'quest_07_solving_for_unknowns', '07-0${i+1 < 10 ? '0'+(i+1) : i+1}', this)` }))
                },
                {
                    ...
                    practice: Array.from({length: 24}, (_, i) => ({ label: `Q ${i+1}`, action: `ManyaRouter.load('math/set_theory', 'quest_08_application_of_sets', '08-0${i+1 < 10 ? '0'+(i+1) : i+1}', this)` }))
                },
                {
                    ...
                    practice: Array.from({length: 29}, (_, i) => ({ label: `Q ${i+1}`, action: `ManyaRouter.load('math/set_theory', 'quest_09_difference_of_sets_complements', '09-0${i+1 < 10 ? '0'+(i+1) : i+1}', this)` }))
                },
                {
                    ...
                    practice: Array.from({length: 36}, (_, i) => ({ label: `Q ${i+1}`, action: `ManyaRouter.load('math/set_theory', 'quest_10_probability_using_venn_diagrams', '10-0${i+1 < 10 ? '0'+(i+1) : i+1}', this)` }))
                }
            ]
        },
        science: {
